  ...
  return (
    <div>
      ...
      >
        ...
        <div style={{ textAlign: "center", padding: "0 2rem" }}>
          ...
          <p
            ...
            style={{ fontFamily: "Poppins", fontSize: 50, marginTop: "1rem" }}
          >
      ...
      >
        ...
        {/* First Section */}
        <div
          style={{ backgroundColor: "#314159", flex: 1, display: "flex", gap: "2rem" }}
          className="responsive-row"
        >
          ...
          <div style={{ flex: 1, padding: "2rem", boxSizing: "border-box" }}>
            <h3 style={{ color: "teal", fontFamily: "Poppins", fontSize: "1.5rem" }}>
              TRACK 1:
            </h3>
            <h4 style={{ fontFamily: "Poppins", fontSize: "2rem", marginTop: "0.5rem" }}>
              Data Science & Big Data Analytics
            </h4>
            <p style={{ fontFamily: "Poppins", marginTop: "1rem", lineHeight: "1.6", color: "#ccc" }}>
        ...
        {/* Second Section */}
        <div style={{ backgroundColor: "#314159", flex: 1, display: "flex", gap: "2rem" }} className="responsive-row">
          <div style={{ width: "15vw" }}>
            <img
              src={heroimage} // Replace with your image path
